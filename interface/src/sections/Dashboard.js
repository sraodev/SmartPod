...
class Dashboard extends Component {
  ...
  render() {
    ...
    const ConfiguredWiFiNetworkScanner = props => {
      return (
        <WiFiNetworkScanner selectNetwork={this.selectNetwork} {...props} />
      );
    };
      ...
      <MenuAppBar sectionTitle="Dashboard">
        ...
        <Switch>
          ...
          <AuthenticatedRoute
            exact={true}
            path="/wifi/scan"
            component={ConfiguredWiFiNetworkScanner}
          />
          <AuthenticatedRoute
            exact={true}
            path="/wifi/settings"
            component={ConfiguredWiFiSettings}
          />
...
export default withAuthenticationContext(Dashboard);
